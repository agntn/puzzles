...
export abstract class Puzzle {
  ...
  /**
   * Hints published about the puzzle, in record order: the author's as `official`, anyone else's
   * as `community`, each with where it was said and what confirms that.
   *
