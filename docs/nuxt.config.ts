...
export default defineNuxtConfig({
  ...
  llms: {
    ...
    title: "@agntn/puzzles",
    description:
      "Public crypto bounties, puzzles and challenges as typed records: 333 puzzles in eleven collections, as a library, a CLI, an MCP server and Pi and OMP extensions.",
    sections: [
      {
        title: "Playground",
