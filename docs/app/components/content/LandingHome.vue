...
<template>
  <div class="puzzles-landing not-prose">
    ...
    >
      Importing the package evaluates no puzzle records. The registry is ten keys and ten
      ...
      other nine. This panel is that mechanism running: the walk pulls collections in one at a time.
      <template #visual>
        <div @mouseenter="paused = true" @mouseleave="paused = false">
