...
├── app/components/content/        # MDC components and page parts: landing panels, PuzzleCard, PuzzlePage, CollectionFacts, CollectionPuzzles, AuthorFacts, AuthorList, PuzzlesPlayground, StatusPill, BalanceLine
