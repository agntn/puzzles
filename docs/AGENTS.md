...
└── content/2.collections/         # one page per collection, each with the facts strip and the puzzle list; the two singletons embed their puzzle page
```
