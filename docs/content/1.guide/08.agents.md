...
title: Agents
icon: i-lucide-bot
description: The same six tools over MCP and the Pi and OMP extensions. What the text carries and where the limits live. The one tool that leaves the process.
---
