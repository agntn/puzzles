...
description: A manifest of twenty keys and twenty lazy imports. Keys and aliases answer at once. Records load on the first lookup for their collection. How to register yours.
---
...
collectionKeys(); // ["arweave", "b1000", "ballet", "bitaps", "bitimage", "book_quiz", "coin_artist", "dug", "genesis", "gsmg", "hash_collision", "ledger_donjon", "luckylurker", "mineshop", "movie_enigma", "quizchain", "rushwallet", "satoshi_birthday_quiz", "warp", "zden"]
