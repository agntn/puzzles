...
description: A manifest of eighteen keys and eighteen lazy imports. Keys and aliases answer at once. Records load on the first lookup for their collection. How to register yours.
---
...
collectionKeys(); // ["arweave", "b1000", "ballet", "bitaps", "bitimage", "coin_artist", "dug", "genesis", "gsmg", "hash_collision", "ledger_donjon", "luckylurker", "mineshop", "movie_enigma", "rushwallet", "satoshi_birthday_quiz", "warp", "zden"]
