...
description: A multi phase image puzzle from April 2019 with a white rabbit for a hint. Started at 5 BTC and halved twice by the author. 1.25 BTC on the address today.
---
...
GSMG.io published an image, a rabbit hole of encoded phases behind it, and 5 BTC on an address whose public key was posted along with it. Nobody finished. The author took half back in 2020 and half of what was left in 2024. So the prize on the record is 1.25 BTC, and the transaction list says exactly where the other 3.75 went.
