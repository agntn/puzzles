...
::collection-facts{collection="satoshi-birthday-quiz"}
::
...
`satoshi-birthday-quiz` is the whole identifier, like [`gsmg`](/collections/gsmg), [`bitaps`](/collections/bitaps), [`mineshop`](/collections/mineshop) and [`movie-enigma`](/collections/movie-enigma). One puzzle, one key, no slash.

## The birthday quiz record

::puzzle-page{puzzle="satoshi-birthday-quiz"}
::
