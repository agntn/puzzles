...
klems is the name on the Nostr profile. cryptop1r4t3 is the handle in the EXIF of all 34 frames and on the X account that announced the puzzle. The [Movie Enigma](/collections/movie_enigma) went out on Twitter, Instagram and Nostr in March 2022, the platforms compressed the stills badly, so a small website followed. The prize was 100,000 sats of the author's own money and the donor list on the wallet page never got a second entry. It was solved in September 2026.
