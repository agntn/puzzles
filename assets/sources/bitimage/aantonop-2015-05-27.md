...
[Original post](https://x.com/aantonop/status/603701870482300928). This is the image source cited by [kitten](../../../src/collections/bitimage/kitten.ts) and [kitten_passphrase](../../../src/collections/bitimage/kitten-passphrase.ts), not an announcement of their later bounties. The transaction claim below is the author's statement, not a verification by this archive.
