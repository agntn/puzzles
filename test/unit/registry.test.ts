...
describe("registry consistency", () => {
  ...
  it("refreshes every aggregate after registration and replacement", async () => {
    ...
    expect(originalPuzzles).toHaveLength(333);
    expect(originalCollections).toHaveLength(11);
    expect(originalData).toHaveLength(11);
    ...
    expect(await lib.collections()).toHaveLength(12);
    expect(await lib.all()).toHaveLength(334);
