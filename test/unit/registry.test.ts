...
describe("registry consistency", () => {
  ...
  it("refreshes every aggregate after registration and replacement", async () => {
    ...
    expect(originalPuzzles).toHaveLength(334);
    expect(originalCollections).toHaveLength(12);
    expect(originalData).toHaveLength(12);
    ...
    expect(await lib.collections()).toHaveLength(13);
    expect(await lib.all()).toHaveLength(335);
